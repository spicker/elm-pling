...
Elm.Pling.make = function (_elm) {
   ...
   var view = F2(function (address,model) {
      ...
      return A2($Html.div,
      _U.list([]),
      _U.list([A2(buttonList,0,7)
              ,A2($Html.div,
              _U.list([]),
              _U.list([A2(buttonList,1,7)
                      ,A2($Html.div,
                      _U.list([]),
                      _U.list([A2(buttonList,2,7)
                              ,A2($Html.div,
                              _U.list([]),
                              _U.list([A2(buttonList,3,7)
                                      ,A2($Html.div,
                                      _U.list([]),
                                      _U.list([A2(buttonList,4,7)
                                              ,A2($Html.div,
                                              _U.list([]),
                                              _U.list([A2(buttonList,5,7)
                                                      ,A2($Html.div,
                                                      _U.list([]),
                                                      _U.list([A2(buttonList,6,7),A2($Html.div,_U.list([]),_U.list([A2(buttonList,7,7)]))]))]))]))]))]))]))]));
   });
   var Reset = {ctor: "Reset"};
   var init = A2($Matrix.repeat,{ctor: "_Tuple2",_0: 8,_1: 8},false);
   var update = F2(function (action,model) {    var _p2 = action;if (_p2.ctor === "Click") {    return A2(toggle,_p2._0,model);} else {    return init;}});
